...
public class StringUtil {
     ...
     * @return
     */
    public static String joinString(double[] n, String format, String delimiter, int initialIndex) {
        if (n.length == 0) {
            return "";
        }
        StringBuilder buffer = new StringBuilder(String.format(format, n[initialIndex]));
        for (int i = initialIndex + 1; i < n.length; ++i) {
            buffer.append(delimiter).append(String.format(format, n[i]));
        }
        return buffer.toString();
    }
     ...
     * @return
     */
    public static String joinString(float[] n, String format, String delimiter, int initialIndex) {
        if (n.length == 0) {
            return "";
        }
        StringBuilder buffer = new StringBuilder(String.format(format, n[initialIndex]));
     ...
     * @return
     */
    public static String joinString(int[] n, String format, String delimiter, int initialIndex) {
        if (n.length == 0) {
            return "";
        }
        StringBuilder buffer = new StringBuilder(String.format(format, n[initialIndex]));
     ...
     * @return
     */
    public static String joinString(long[] n, String format, String delimiter, int initialIndex) {
        if (n.length == 0) {
            return "";
        }
        StringBuilder buffer = new StringBuilder(String.format(format, n[initialIndex]));
